...
export default function Supplier() {
  ...
  const fetchData = () => {
    axios
      .get(`${ServiceURL}/staff/PurchaseList`)
      .then((response) => {
  ...
  const handleNotification = (id) => {
    axios
      .put(`${ServiceURL}/staff/notifysupplier`, { id })
      .then((response) => {
        ...
        <Table sx={{ minWidth: 1000 }} aria-label="custom pagination table">
          <TableHead>
            <TableRow>
              ...
              <TableCell align="center">Notify Supplier</TableCell>
          ...
          <TableBody>
            {(rowsPerPage > 0
              ...
              <TableRow key={row.PurchaseID}>
                ...
                <TableCell style={{ width: 160 }} align="center">
                  <IconButton onClick={()=>{handleNotification(row.PurchaseID)}}>
                    <NotificationsIcon />
                  </IconButton>
                </TableCell>
                <TableCell style={{ width: 160 }} align="center">
